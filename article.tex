...
\setCJKmainfont{SimSun}%[ItalicFont=SimFang, BoldFont=SimHei]
...
\pagestyle{fancy}
	...
	\fancypagestyle{firstpage}{
		...
		\fancyhead[C]{\large\kaishu 武汉大学物理科学与技术学院\\物理实验报告
		          }
	}
...
%%begin-------------------中文摘要-----------------------%%
\title{\heiti \newtitle}
\author{\zihao{3}\kaishu 2018302020200\quad 周澳}
\date{}%不显示日期
